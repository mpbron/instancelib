...
- Rudimentary support for text classification pipelines from HuggingFace
...
## [0.4.9.1]
### Fixed
- Unhandled JSON Decode Error when loading a TREC dataset

## [0.4.9.0]
### Added
- Added shuffling methods that permute the identifiers in the InstanceProviders etc., but keep the relations intact.

### Fixed
- Fixed deprecation errors for numpy.bool8 in NumPy 1.24.
